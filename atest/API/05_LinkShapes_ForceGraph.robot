...
*** Test Cases ***
ForceGraph Can Set Link color using str inputs
    Shape Link Feature Works As Expected    ForceGraph    color    str    blue    red    1

ForceGraph Can Set Link color using Column inputs
    Shape Link Feature Works As Expected    ForceGraph    color    Column    a_color    other_color    2

ForceGraph Can Set Link color using Nunjucks inputs
...
ForceGraph Can Set Link curvature using int inputs
    Shape Link Feature Works As Expected    ForceGraph    curvature    int    1    2    1

ForceGraph Can Set Link curvature using float inputs
    Shape Link Feature Works As Expected    ForceGraph    curvature    float    1.5    3.0    2

ForceGraph Can Set Link curvature using Column inputs
    Shape Link Feature Works As Expected    ForceGraph    curvature    Column    value_small    value_large    3

ForceGraph Can Set Link curvature using Nunjucks inputs
    Shape Link Feature Works As Expected
    ...    ForceGraph
    ...    curvature
    ...    Nunjucks
...
ForceGraph Can Set Link line_dash using Nunjucks inputs
    Shape Link Feature Works As Expected
    ...    ForceGraph
    ...    line_dash
    ...    Nunjucks
...
ForceGraph Can Set Link width using int inputs
    Shape Link Feature Works As Expected    ForceGraph    width    int    2    5    1

ForceGraph Can Set Link width using float inputs
    Shape Link Feature Works As Expected    ForceGraph    width    float    0.5    2.5    2

ForceGraph Can Set Link width using Column inputs
    Shape Link Feature Works As Expected    ForceGraph    width    Column    value_small    value_large    3

ForceGraph Can Set Link width using Nunjucks inputs
    Shape Link Feature Works As Expected
    ...    ForceGraph
    ...    width
    ...    Nunjucks
