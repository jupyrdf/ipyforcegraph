...
ForceGraph Can Update Text Fill
    Link Shape Feature Works As Expected    ForceGraph    Text    fill

ForceGraph Can Update Text Background
    Link Shape Feature Works As Expected    ForceGraph    Text    background

ForceGraph Can Update Text Stroke
    Link Shape Feature Works As Expected    ForceGraph    Text    stroke
